...
void blas_blocked_kij_algorithm(int n, int cacheBlock, double* a, double* b,
        double* result);
void blas_nonblocked_ijk_algorithm(int n, double* a, double* b,
        double* result);
void blas_nonblocked_kij_algorithm(int n, double* a, double* b,
        double* result);
...
int main(int argc, char** argv) {
    ...
    blas_nonblocked_ijk_algorithm(n, a, b, result);
    blas_nonblocked_kij_algorithm(n, a, b, result);
